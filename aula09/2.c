...
// Variáveis globais, para guardar as coordenadas dos vértices(linha)
int linha[4];
...
// Ao detectar um clique vem aqui, onde é feito a lógica de desenhar a linha
...
// Aqui é para detectar o teclado, mudando de cor quando necessário
